    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_link', filer.fields.file.FilerFileField(on_delete=models.CASCADE, related_name='+', default=None, to='filer.File', blank=True, help_text='if present image will be clickable', null=True, verbose_name='file link')),
                ('image', filer.fields.image.FilerImageField(on_delete=models.CASCADE, default=None, blank=True, to='filer.Image', null=True, verbose_name='image')),
